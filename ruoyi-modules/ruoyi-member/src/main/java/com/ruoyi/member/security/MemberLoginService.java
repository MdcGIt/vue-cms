...
public class MemberLoginService {
	...
	public String login(String username, String password, String code, String uuid) {
		...
		if (!SecurityUtils.matches(password, user.getPassword())) {
			...
			// 记录日志
			asyncTaskManager.execute(this.logininfoService.recordLogininfor(MemberUserType.TYPE, user.getUserId(),
		...
		StpMemberUtil.login(user.getUserId(), DeviceType.PC.value());
		loginUser.setToken(StpMemberUtil.getTokenValueByLoginId(user.getUserId()));
	...
	public void validateCaptcha(String username, String code, String uuid) {
		...
		Assert.notNull(captcha, () -> {
			asyncTaskManager.execute(this.logininfoService.recordLogininfor(MemberUserType.TYPE, null, username,
