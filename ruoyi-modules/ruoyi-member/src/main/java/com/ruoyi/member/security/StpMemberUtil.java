...
public class StpMemberUtil {
	 ...
	 * 账号类型标识 
	 */
	public static final String TYPE = MemberUserType.TYPE;
	...
	/**
	 * 封禁：指定账号
	 * <p> 此方法不会直接将此账号id踢下线，如需封禁后立即掉线，请追加调用 StpAdminUtil.logout(id)
	 * 
	 * @param loginId 指定账号id 
	...
	public static void setLoginUser(LoginUser loginUser) {
		if (isLogin()) {
			getTokenSession().set(SaSession.USER, loginUser);
		}
	}
}
