...
import com.ruoyi.common.log.restful.RestfulLogData;
import com.ruoyi.common.log.restful.RestfulLogType;
...
public class SysLogHandler implements ILogHandler {
	...
	private void processOperLog(LogDetail logDetail) {
		...
		if (StringUtils.containsAny(requestMethod, RequestMethod.GET.name(), RequestMethod.HEAD.name())) {
			return;
		}
		try {
