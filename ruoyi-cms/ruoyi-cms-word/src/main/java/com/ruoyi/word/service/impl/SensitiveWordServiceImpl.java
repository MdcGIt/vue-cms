...
public class SensitiveWordServiceImpl extends ServiceImpl<CmsSensitiveWordMapper, CmsSensitiveWord>
	...
	public void run(String... args) throws Exception {
		// 敏感词黑名单
		List<CmsSensitiveWord> blackList = this.lambdaQuery()
				.eq(CmsSensitiveWord::getType, SensitiveWordType.BLACK.name()).list();
		// 敏感词白名单
		List<CmsSensitiveWord> whiteList = this.lambdaQuery()
				.eq(CmsSensitiveWord::getType, SensitiveWordType.WHITE.name()).list();
