package com.ruoyi.word.sensitive;
...
public class SensitiveWordProcessor {
	 ...
	 * @param whiteList
	 */
	public void init(List<CmsSensitiveWord> blackList, List<CmsSensitiveWord> whiteList) {
		this.init(blackList.stream().map(CmsSensitiveWord::getWord).collect(Collectors.toSet()), 
